...
define( 'DB_NAME', $env_info['wp_db_name'] ); // Misma BD que WordPress
define( 'DB_USER', $env_info['wp_db_user'] ); // Mismo usuario
define( 'DB_PASSWORD', DB_PASSWORD );          // Misma contraseña
define( 'DB_HOST', $env_info['wp_db_host'] );  // Mismo host/socket
...
define( 'AUTH_KEY',         'test-auth-key-for-testing-only' );
define( 'SECURE_AUTH_KEY',  'test-secure-auth-key-for-testing-only' );
define( 'LOGGED_IN_KEY',    'test-logged-in-key-for-testing-only' );
define( 'NONCE_KEY',        'test-nonce-key-for-testing-only' );
define( 'AUTH_SALT',        'test-auth-salt-for-testing-only' );
define( 'SECURE_AUTH_SALT', 'test-secure-auth-salt-for-testing-only' );
define( 'LOGGED_IN_SALT',   'test-logged-in-salt-for-testing-only' );
