  ...
  return _createClass(TestRunner, [{
    ...
    value: function displayResults(results) {
      ...
      if (results.summary) {
        ...
        var statusColor = '#10b981'; // Verde por defecto (éxito)
        var statusIcon = '✅';
        var statusText = 'Éxito';
