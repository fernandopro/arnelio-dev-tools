  ...
  return _createClass(TestRunner, [{
    ...
    value: (function () {
      var _runTests = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        ...
        var testTypes, verbose, coverage, testdox, response, _t3;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              if (!this.isRunning) {
            ...
            case 1:
              ...
              testTypes = [];
              if ((_document$getElementB = document.getElementById('devtools-devtoolsTests')) !== null && _document$getElementB !== void 0 && _document$getElementB.checked) testTypes.push('devtools');
              if ((_document$getElementB2 = document.getElementById('devtools-pluginTests')) !== null && _document$getElementB2 !== void 0 && _document$getElementB2.checked) testTypes.push('plugin');
              verbose = ((_document$getElementB3 = document.getElementById('devtools-verboseOutput')) === null || _document$getElementB3 === void 0 ? void 0 : _document$getElementB3.checked) || false;
              coverage = ((_document$getElementB4 = document.getElementById('devtools-generateCoverage')) === null || _document$getElementB4 === void 0 ? void 0 : _document$getElementB4.checked) || false;
              testdox = ((_document$getElementB5 = document.getElementById('devtools-testdoxOutput')) === null || _document$getElementB5 === void 0 ? void 0 : _document$getElementB5.checked) || false;
