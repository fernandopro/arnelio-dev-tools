...
/* harmony import */ var core_js_modules_es_object_proto_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_proto_js__WEBPACK_IMPORTED_MODULE_7__);
...
/* harmony import */ var core_js_modules_esnext_iterator_find_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! core-js/modules/esnext.iterator.find.js */ "./node_modules/core-js/modules/esnext.iterator.find.js");
/* harmony import */ var core_js_modules_esnext_iterator_find_js__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_esnext_iterator_find_js__WEBPACK_IMPORTED_MODULE_14__);
...
if (window.devTools) {
  window.devTools.testRunner = {
     ...
     */
    runTest: function runTest(testType) {
      var _arguments = arguments,
        _this = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var testFile, response, _t;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              testFile = _arguments.length > 1 && _arguments[1] !== undefined ? _arguments[1] : '';
              if (!_this.isRunning) {
                _context.n = 1;
                break;
              }
              _this.showMessage('Ya hay un test en ejecución...', 'warning');
              return _context.a(2);
            case 1:
              _this.isRunning = true;
              _context.p = 2;
              _this.showMessage("\uD83D\uDD04 Ejecutando ".concat(testType, "..."), 'info');

              // Usar el sistema AJAX existente de dev-tools
              _context.n = 3;
              return window.devTools.makeRequest('run_tests', {
                test_type: testType,
                test_file: testFile
              });
            case 3:
              response = _context.v;
              if (response.success) {
                _this.displayResults(response.data);
              } else {
                _this.showError('Error: ' + (response.data || 'Error desconocido'));
              }
              _context.n = 5;
              break;
            case 4:
              _context.p = 4;
              _t = _context.v;
              console.error('Error ejecutando test:', _t);
              _this.showError('Error de conexión: ' + _t.message);
            case 5:
              _context.p = 5;
    ...
    displayResults: function displayResults(results) {
      ...
      var html = this.formatResults(results);
     ...
     */
    formatResults: function formatResults(results) {
      var output = results.output,
        return_code = results.return_code,
        execution_time = results.execution_time,
        command = results.command;
      var statusClass = return_code === 0 ? 'success' : 'danger';
      var statusIcon = return_code === 0 ? '✅' : '❌';
      var statusText = return_code === 0 ? 'PASÓ' : 'FALLÓ';
      var timestamp = new Date().toLocaleString('es-ES');
      return "\n                <div class=\"card border-".concat(statusClass, " mb-3\">\n                    <div class=\"card-header bg-").concat(statusClass, " text-white\">\n                        <h5 class=\"mb-0\">\n                            ").concat(statusIcon, " Test ").concat(statusText, "\n                            <small class=\"float-end\">").concat(timestamp, "</small>\n                        </h5>\n                    </div>\n                    <div class=\"card-body\">\n                        <div class=\"row mb-3\">\n                            <div class=\"col-md-6\">\n                                <strong>Comando:</strong>\n                                <code class=\"d-block bg-light p-2 rounded\">").concat(command, "</code>\n                            </div>\n                            <div class=\"col-md-3\">\n                                <strong>C\xF3digo:</strong>\n                                <span class=\"badge bg-").concat(statusClass, "\">").concat(return_code, "</span>\n                            </div>\n                            <div class=\"col-md-3\">\n                                <strong>Tiempo:</strong>\n                                <span class=\"badge bg-info\">").concat(execution_time, "ms</span>\n                            </div>\n                        </div>\n                        \n                        <div class=\"test-output\">\n                            <strong>Salida del Test:</strong>\n                            <pre class=\"bg-dark text-light p-3 rounded mt-2\" style=\"max-height: 400px; overflow-y: auto;\"><code>").concat(this.escapeHtml(output), "</code></pre>\n                        </div>\n\n                        ").concat(this.generateSummary(output, return_code), "\n                    </div>\n                </div>\n            ");
    },
    /**
     * Generar resumen
     */
    generateSummary: function generateSummary(output, return_code) {
      var lines = output.split('\n');
      var summaryLine = lines.find(function (line) {
        return line.includes('Tests:') || line.includes('OK');
      });
      if (summaryLine) {
        var summaryClass = return_code === 0 ? 'success' : 'danger';
        return "\n                    <div class=\"alert alert-".concat(summaryClass, " mt-3\">\n                        <strong>\uD83D\uDCCA Resumen:</strong> ").concat(summaryLine.trim(), "\n                    </div>\n                ");
      }
      return '';
    },
    /**
    ...
    showMessage: function showMessage(message) {
      ...
      testResultsDiv.innerHTML = "\n                <div class=\"alert ".concat(alertClass, "\" role=\"alert\">\n                    ").concat(message, "\n                </div>\n            ");
    },
    /**
     * Mostrar error
     */
    showError: function showError(message) {
      this.showMessage("\u274C ".concat(message), 'danger');
    },
    /**
     * Limpiar resultados
     */
    clearResults: function clearResults() {
      var testResultsDiv = document.getElementById('testResults');
      if (testResultsDiv) {
        testResultsDiv.innerHTML = "\n                    <div class=\"alert alert-secondary\" role=\"alert\">\n                        <i class=\"fas fa-info-circle\"></i> Los resultados aparecer\xE1n aqu\xED...\n                    </div>\n                ";
      }
    },
    /**
     * Escapar HTML
