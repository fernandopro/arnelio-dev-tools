...
/* harmony import */ var core_js_modules_web_url_search_params_delete_js__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! core-js/modules/web.url-search-params.delete.js */ "./node_modules/core-js/modules/web.url-search-params.delete.js");
/* harmony import */ var core_js_modules_web_url_search_params_delete_js__WEBPACK_IMPORTED_MODULE_27___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_url_search_params_delete_js__WEBPACK_IMPORTED_MODULE_27__);
/* harmony import */ var core_js_modules_web_url_search_params_has_js__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! core-js/modules/web.url-search-params.has.js */ "./node_modules/core-js/modules/web.url-search-params.has.js");
/* harmony import */ var core_js_modules_web_url_search_params_has_js__WEBPACK_IMPORTED_MODULE_28___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_url_search_params_has_js__WEBPACK_IMPORTED_MODULE_28__);
/* harmony import */ var core_js_modules_web_url_search_params_size_js__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! core-js/modules/web.url-search-params.size.js */ "./node_modules/core-js/modules/web.url-search-params.size.js");
/* harmony import */ var core_js_modules_web_url_search_params_size_js__WEBPACK_IMPORTED_MODULE_29___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_url_search_params_size_js__WEBPACK_IMPORTED_MODULE_29__);
...
/* harmony import */ var _test_runner_js__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./test-runner.js */ "./src/js/test-runner.js");
...
var DevTools = /*#__PURE__*/function () {
  ...
  return _createClass(DevTools, [{
    ...
    value: function setup() {
      ...
      this.testRunner = new _test_runner_js__WEBPACK_IMPORTED_MODULE_31__["default"](this);
    ...
    value: function initializeTabs() {
      var _this2 = this;
      var tabElements = document.querySelectorAll('.nav-tabs [data-bs-toggle="tab"]');
      tabElements.forEach(function (tabElement) {
        new bootstrap__WEBPACK_IMPORTED_MODULE_30__.Tab(tabElement);

        // Event listener para carga lazy de contenido
        tabElement.addEventListener('shown.bs.tab', function (event) {
          var targetId = event.target.getAttribute('data-bs-target').substring(1);
          _this2.loadTabContent(targetId);
        });
      });
    }
    ...
    value: function bindEvents() {
      ...
      window.addEventListener('unhandledrejection', function (event) {
        _this3.handleError('Unhandled Promise Rejection', event.reason);
      });
    }
    ...
    key: "bindQuickActions",
    value: function bindQuickActions() {
      var _this4 = this;
      // Test Database
      var testDbBtn = document.querySelector('[data-action="test-database"]');
      if (testDbBtn) {
        testDbBtn.addEventListener('click', function () {
          return _this4.testDatabase();
        });
      }

      // Test Site URL
      var testUrlBtn = document.querySelector('[data-action="test-site-url"]');
      if (testUrlBtn) {
        testUrlBtn.addEventListener('click', function () {
          return _this4.testSiteUrl();
        });
      }

      // Clear Cache
      var clearCacheBtn = document.querySelector('[data-action="clear-cache"]');
      if (clearCacheBtn) {
      ...
      document.addEventListener('click', function (e) {
        ...
        var target = e.target.closest('[data-quick-action]');
        if (!target) return;
        var action = target.getAttribute('data-quick-action');
        switch (action) {
          case 'test-database':
            _this4.testDatabase();
            break;
          ...
          case 'run-quick-test':
            ...
            if (_this4.testRunner) {
              _this4.testRunner.runQuickTest();
            } else {
    ...
    value: function bindForms() {
      var _this5 = this;
      // AJAX Tester Form
      var ajaxForm = document.getElementById('ajaxTestForm');
      if (ajaxForm) {
    ...
    value: function setupErrorHandling() {
      ...
      window.addEventListener('error', function (event) {
        _this6.handleError('JavaScript Error', event.error);
      });
    }
    ...
    key: "makeAjaxRequest",
    value: (function () {
      var _makeAjaxRequest = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(command) {
        var _this7 = this;
        var data,
          options,
          requestKey,
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              ...
              requestKey = "".concat(command, "-").concat(JSON.stringify(data)); // Check cache if enabled
              if (!(options.useCache && this.cache.has(requestKey))) {
                _context2.n = 1;
                break;
              }
              return _context2.a(2, this.cache.get(requestKey));
            case 1:
              if (!this.activeRequests.has(requestKey)) {
                _context2.n = 2;
                break;
              }
              return _context2.a(2, this.activeRequests.get(requestKey));
            case 2:
              requestBody = {
              ...
              requestPromise = fetch(this.apiUrl, {
                method: 'POST',
                headers: {
                  ...
                  return _regenerator().w(function (_context) {
                    while (1) switch (_context.n) {
                      ...
                      case 2:
                        ...
                        throw new Error(((_result$data = result.data) === null || _result$data === void 0 ? void 0 : _result$data.message) || 'Unknown error occurred');
                      case 3:
                        // Cache successful results if enabled
                        if (options.useCache) {
                          _this7.cache.set(requestKey, result.data);
                        }
                ...
                _this7.activeRequests.delete(requestKey);
              });
    ...
    key: "testDatabase",
    value: (function () {
      var _testDatabase = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var result, _t;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              ...
              _context3.p = 1;
              _context3.n = 2;
              return this.makeAjaxRequest('test_connection');
            case 2:
              result = _context3.v;
              this.hideLoading();
            ...
            case 3:
              ...
              _t = _context3.v;
              this.hideLoading();
              this.showError('Database Test Failed', _t.message);
            case 4:
    ...
    key: "testSiteUrl",
    value: (function () {
      var _testSiteUrl = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        var result, _t2;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.n) {
            case 0:
              ...
              _context4.p = 1;
              _context4.n = 2;
              return this.makeAjaxRequest('site_url_detection');
            case 2:
              result = _context4.v;
              this.hideLoading();
            ...
            case 3:
              ...
              _t2 = _context4.v;
              this.hideLoading();
              this.showError('Site URL Test Failed', _t2.message);
            case 4:
      ...
      function testSiteUrl() {
        return _testSiteUrl.apply(this, arguments);
      }
      return testSiteUrl;
    }()
    /**
    ...
    key: "runTests",
    value: (function () {
      var _runTests = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        var selectedTests, options, result, _t3;
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.n) {
            case 0:
              selectedTests = this.getSelectedTestTypes();
              options = this.getTestOptions();
              this.showLoading('Running tests...');
              _context5.p = 1;
              _context5.n = 2;
              return this.makeAjaxRequest('run_tests', {
                types: selectedTests,
                options: options
              });
            case 2:
            ...
            case 3:
              ...
              _t3 = _context5.v;
              this.hideLoading();
              this.showError('Tests Failed', _t3.message);
            case 4:
    ...
    key: "testAjax",
    value: (function () {
      var _testAjax = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        var command, dataText, data, result, _t4, _t5;
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.n) {
            case 0:
              command = document.getElementById('ajaxCommand').value;
              dataText = document.getElementById('ajaxData').value;
              data = {};
              _context6.p = 1;
            ...
            case 3:
              ...
              _context6.p = 4;
              _context6.n = 5;
              return this.makeAjaxRequest(command, data);
            case 5:
              result = _context6.v;
              this.hideLoading();
            ...
            case 6:
              ...
              _t5 = _context6.v;
              this.hideLoading();
              this.showError('AJAX Test Failed', _t5.message);
            case 7:
              return _context6.a(2);
          }
        }, _callee6, this, [[4, 6], [1, 2]]);
      }));
      function testAjax() {
        return _testAjax.apply(this, arguments);
      }
      return testAjax;
    }()
    /**
    ...
    key: "clearCache",
    value: (function () {
      var _clearCache = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        var _t6;
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.n) {
            case 0:
              ...
              _context7.p = 1;
              _context7.n = 2;
              return this.makeAjaxRequest('clear_cache');
            case 2:
              this.cache.clear();
              this.hideLoading();
            ...
            case 3:
              ...
              _t6 = _context7.v;
              this.hideLoading();
              this.showError('Cache Clear Failed', _t6.message);
            case 4:
    ...
    key: "loadTabContent",
    value: (function () {
      var _loadTabContent = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8(tabId) {
        var tabContent, _t7;
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.n) {
            ...
            case 1:
              ...
              _t7 = tabId;
              _context8.n = _t7 === 'system-info' ? 2 : _t7 === 'database' ? 4 : 6;
              break;
            case 2:
              _context8.n = 3;
    ...
    key: "loadSystemInfo",
    value: (function () {
      var _loadSystemInfo = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
        var container, result, _t8;
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.n) {
            case 0:
              container = document.querySelector('#system-info .system-info-content');
              if (container) {
                _context9.n = 1;
                break;
              }
            ...
            case 1:
              _context9.p = 1;
              _context9.n = 2;
              return this.makeAjaxRequest('system_info', {}, {
                useCache: true
              });
            case 2:
              result = _context9.v;
    ...
    key: "getSelectedTestTypes",
    value: function getSelectedTestTypes() {
    ...
    key: "getTestOptions",
    value: function getTestOptions() {
      var _document$getElementB, _document$getElementB2;
      return {
        verbose: ((_document$getElementB = document.getElementById('verboseOutput')) === null || _document$getElementB === void 0 ? void 0 : _document$getElementB.checked) || false,
        coverage: ((_document$getElementB2 = document.getElementById('generateCoverage')) === null || _document$getElementB2 === void 0 ? void 0 : _document$getElementB2.checked) || false
      };
    }
    ...
    key: "showResult",
    value: function showResult(title, content) {
    ...
    key: "updateTestResults",
    value: function updateTestResults(result) {
    ...
    key: "updateAjaxResult",
    value: function updateAjaxResult(result) {
      var container = document.getElementById('ajaxResult');
      if (container) {
    ...
    key: "formatConnectionResult",
    value: function formatConnectionResult(result) {
      return "<pre>".concat(JSON.stringify(result, null, 2), "</pre>");
    }
    ...
    key: "formatUrlResult",
    value: function formatUrlResult(result) {
      return "<pre>".concat(JSON.stringify(result, null, 2), "</pre>");
    }
    ...
    key: "formatTestResults",
    value: function formatTestResults(result) {
      return "<pre>".concat(JSON.stringify(result, null, 2), "</pre>");
    }
    ...
    key: "formatAjaxResult",
    value: function formatAjaxResult(result) {
      return "<pre>".concat(JSON.stringify(result, null, 2), "</pre>");
    }
    ...
    key: "formatSystemInfo",
    value: function formatSystemInfo(info) {
      return "<pre>".concat(JSON.stringify(info, null, 2), "</pre>");
    }
    ...
    key: "handleError",
    value: function handleError(title, error) {
      console.error("[DevTools] ".concat(title, ":"), error);
    ...
    value: function log(message) {
      ...
      (_console = console).log.apply(_console, ["[DevTools ".concat(timestamp, "]"), message].concat(args));
    }
  }]);
...
/* harmony import */ var core_js_modules_web_url_search_params_delete_js__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! core-js/modules/web.url-search-params.delete.js */ "./node_modules/core-js/modules/web.url-search-params.delete.js");
/* harmony import */ var core_js_modules_web_url_search_params_delete_js__WEBPACK_IMPORTED_MODULE_26___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_url_search_params_delete_js__WEBPACK_IMPORTED_MODULE_26__);
/* harmony import */ var core_js_modules_web_url_search_params_has_js__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! core-js/modules/web.url-search-params.has.js */ "./node_modules/core-js/modules/web.url-search-params.has.js");
/* harmony import */ var core_js_modules_web_url_search_params_has_js__WEBPACK_IMPORTED_MODULE_27___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_url_search_params_has_js__WEBPACK_IMPORTED_MODULE_27__);
/* harmony import */ var core_js_modules_web_url_search_params_size_js__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! core-js/modules/web.url-search-params.size.js */ "./node_modules/core-js/modules/web.url-search-params.size.js");
/* harmony import */ var core_js_modules_web_url_search_params_size_js__WEBPACK_IMPORTED_MODULE_28___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_url_search_params_size_js__WEBPACK_IMPORTED_MODULE_28__);
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _regenerator() { /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */ var e, t, r = "function" == typeof Symbol ? Symbol : {}, n = r.iterator || "@@iterator", o = r.toStringTag || "@@toStringTag"; function i(r, n, o, i) { var c = n && n.prototype instanceof Generator ? n : Generator, u = Object.create(c.prototype); return _regeneratorDefine2(u, "_invoke", function (r, n, o) { var i, c, u, f = 0, p = o || [], y = !1, G = { p: 0, n: 0, v: e, a: d, f: d.bind(e, 4), d: function d(t, r) { return i = t, c = 0, u = e, G.n = r, a; } }; function d(r, n) { for (c = r, u = n, t = 0; !y && f && !o && t < p.length; t++) { var o, i = p[t], d = G.p, l = i[2]; r > 3 ? (o = l === n) && (u = i[(c = i[4]) ? 5 : (c = 3, 3)], i[4] = i[5] = e) : i[0] <= d && ((o = r < 2 && d < i[1]) ? (c = 0, G.v = n, G.n = i[1]) : d < l && (o = r < 3 || i[0] > n || n > l) && (i[4] = r, i[5] = n, G.n = l, c = 0)); } if (o || r > 1) return a; throw y = !0, n; } return function (o, p, l) { if (f > 1) throw TypeError("Generator is already running"); for (y && 1 === p && d(p, l), c = p, u = l; (t = c < 2 ? e : u) || !y;) { i || (c ? c < 3 ? (c > 1 && (G.n = -1), d(c, u)) : G.n = u : G.v = u); try { if (f = 2, i) { if (c || (o = "next"), t = i[o]) { if (!(t = t.call(i, u))) throw TypeError("iterator result is not an object"); if (!t.done) return t; u = t.value, c < 2 && (c = 0); } else 1 === c && (t = i.return) && t.call(i), c < 2 && (u = TypeError("The iterator does not provide a '" + o + "' method"), c = 1); i = e; } else if ((t = (y = G.n < 0) ? u : r.call(n, G)) !== a) break; } catch (t) { i = e, c = 1, u = t; } finally { f = 1; } } return { value: t, done: y }; }; }(r, o, i), !0), u; } var a = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} t = Object.getPrototypeOf; var c = [][n] ? t(t([][n]())) : (_regeneratorDefine2(t = {}, n, function () { return this; }), t), u = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(c); function f(e) { return Object.setPrototypeOf ? Object.setPrototypeOf(e, GeneratorFunctionPrototype) : (e.__proto__ = GeneratorFunctionPrototype, _regeneratorDefine2(e, o, "GeneratorFunction")), e.prototype = Object.create(u), e; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, _regeneratorDefine2(u, "constructor", GeneratorFunctionPrototype), _regeneratorDefine2(GeneratorFunctionPrototype, "constructor", GeneratorFunction), GeneratorFunction.displayName = "GeneratorFunction", _regeneratorDefine2(GeneratorFunctionPrototype, o, "GeneratorFunction"), _regeneratorDefine2(u), _regeneratorDefine2(u, o, "Generator"), _regeneratorDefine2(u, n, function () { return this; }), _regeneratorDefine2(u, "toString", function () { return "[object Generator]"; }), (_regenerator = function _regenerator() { return { w: i, m: f }; })(); }
function _regeneratorDefine2(e, r, n, t) { var i = Object.defineProperty; try { i({}, "", {}); } catch (e) { i = 0; } _regeneratorDefine2 = function _regeneratorDefine(e, r, n, t) { if (r) i ? i(e, r, { value: n, enumerable: !t, configurable: !t, writable: !t }) : e[r] = n;else { var o = function o(r, n) { _regeneratorDefine2(e, r, function (e) { return this._invoke(r, n, e); }); }; o("next", 0), o("throw", 1), o("return", 2); } }, _regeneratorDefine2(e, r, n, t); }
...
var TestRunner = /*#__PURE__*/function () {
  ...
  return _createClass(TestRunner, [{
    key: "makeTestAjaxRequest",
    value: (function () {
      var _makeTestAjaxRequest = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(action) {
        var data,
          nonce,
          apiUrl,
          requestBody,
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              nonce = typeof devToolsConfig !== 'undefined' ? devToolsConfig.nonce : '';
              apiUrl = typeof devToolsConfig !== 'undefined' ? devToolsConfig.ajaxurl : this.devTools.apiUrl;
              console.log('🔍 AJAX Debug Info:');
              console.log('  - URL:', apiUrl);
              console.log('  - Action:', "dev_tools_".concat(action));
              ...
              requestBody = _objectSpread({
                action: "dev_tools_".concat(action),
                nonce: nonce
              }, data);
            ...
            case 6:
              ...
              throw new Error(((_result$data = result.data) === null || _result$data === void 0 ? void 0 : _result$data.message) || 'Error en la respuesta del servidor');
            case 7:
              return _context.a(2, result.data);
          }
        }, _callee, this, [[4, 5]]);
      }));
      function makeTestAjaxRequest(_x) {
        return _makeTestAjaxRequest.apply(this, arguments);
      }
      return makeTestAjaxRequest;
    }()
    /**
    ...
    key: "runTest",
    value: (function () {
      var _runTest = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(testType) {
        var testFile,
          response,
          _args2 = arguments,
          _t2;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              testFile = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : '';
              if (!this.isRunning) {
                _context2.n = 1;
                break;
              }
            ...
            case 1:
              this.isRunning = true;
              _context2.p = 2;
              this.showMessage("\uD83D\uDD04 Ejecutando ".concat(testType, "..."), 'info');

              // Usar el sistema AJAX específico para tests
              _context2.n = 3;
              return this.makeTestAjaxRequest('run_tests', {
                test_type: testType,
                test_file: testFile
              });
            case 3:
            ...
            case 4:
              _context2.p = 4;
              _t2 = _context2.v;
              console.error('Error ejecutando test:', _t2);
              this.showError('Error de conexión: ' + _t2.message);
            case 5:
              _context2.p = 5;
              this.isRunning = false;
    ...
    key: "runTests",
    value: (function () {
      var _runTests = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var _document$getElementB, _document$getElementB2, _document$getElementB3;
        var selectedTestType, testTypes, verbose, coverage, testdox, response, _t3;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              if (!this.isRunning) {
            ...
            case 1:
              ...
              selectedTestType = document.querySelector('input[name="testType"]:checked');
              if (selectedTestType) {
                _context3.n = 2;
                break;
              }
              ...
              return _context3.a(2);
            case 2:
              testTypes = [selectedTestType.value]; // Solo un tipo ahora
              verbose = ((_document$getElementB = document.getElementById('devtools-verboseOutput')) === null || _document$getElementB === void 0 ? void 0 : _document$getElementB.checked) || false;
              coverage = ((_document$getElementB2 = document.getElementById('devtools-generateCoverage')) === null || _document$getElementB2 === void 0 ? void 0 : _document$getElementB2.checked) || false;
              testdox = ((_document$getElementB3 = document.getElementById('devtools-testdoxOutput')) === null || _document$getElementB3 === void 0 ? void 0 : _document$getElementB3.checked) || false;
              this.isRunning = true;
            ...
            case 5:
              _context3.p = 5;
              _t3 = _context3.v;
              console.error('Error ejecutando tests:', _t3);
              this.showError('Error de conexión: ' + _t3.message);
            case 6:
              _context3.p = 6;
              this.isRunning = false;
    ...
    key: "runQuickTest",
    value: (function () {
      var _runQuickTest = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        var response, _t4;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.n) {
            case 0:
            ...
            case 1:
              ...
              _context4.p = 2;
              _context4.n = 3;
              return this.makeTestAjaxRequest('run_quick_test', {});
            case 3:
            ...
            case 4:
              _context4.p = 4;
              _t4 = _context4.v;
              console.error('Error ejecutando quick test:', _t4);
              this.showError('Error de conexión: ' + _t4.message);
            case 5:
              _context4.p = 5;
              this.isRunning = false;
      ...
      function runQuickTest() {
        return _runQuickTest.apply(this, arguments);
      }
      return runQuickTest;
    }()
    /**
    ...
    value: (function () {
      var _testConnectivity = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        var startTime, response, endTime, connectivityInfo, _t5;
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.n) {
            case 0:
              if (!this.isRunning) {
            ...
            case 4:
              _context5.p = 4;
              _t5 = _context5.v;
              console.error('Error en test de conectividad:', _t5);
              this.showError('❌ Error de conectividad: ' + _t5.message);
            case 5:
              _context5.p = 5;
              this.isRunning = false;
      ...
      function testConnectivity() {
        return _testConnectivity.apply(this, arguments);
      }
    ...
    value: function displayResults(results) {
      var testResultsDiv = document.getElementById('devtools-testResults');
      if (!testResultsDiv) {
      ...
      if (results.command) {
        html += "<div class=\"modern-section\">\n                <div class=\"modern-section-title\">Comando ejecutado</div>\n                <pre class=\"modern-code-block modern-code-block-light\"><code>".concat(this.escapeHtml(results.command), "</code></pre>\n            </div>");
      }

      // Resumen de resultados
      if (results.summary) {
        var summary = results.summary;
        html += "<div class=\"modern-info-grid-container\">\n                <!-- Grid 1: M\xE9tricas principales (izquierda) -->\n                <div class=\"modern-info-grid modern-info-grid-metrics\">\n                    <div class=\"modern-info-item total\" data-type=\"total\">\n                        <div class=\"modern-info-value\">".concat(summary.total_tests, "</div>\n                        <div class=\"modern-info-label\">Total</div>\n                    </div>\n                    <div class=\"modern-info-item success\" data-type=\"success\">\n                        <div class=\"modern-info-value\">").concat(summary.passed, "</div>\n                        <div class=\"modern-info-label\">Pasados</div>\n                    </div>\n                    <div class=\"modern-info-item ").concat(summary.failed > 0 ? 'error' : 'muted', "\" data-type=\"").concat(summary.failed > 0 ? 'error' : 'muted', "\">\n                        <div class=\"modern-info-value\">").concat(summary.failed, "</div>\n                        <div class=\"modern-info-label\">Fallidos</div>\n                    </div>\n                    <div class=\"modern-info-item ").concat(summary.errors > 0 ? 'warning' : 'muted', "\" data-type=\"").concat(summary.errors > 0 ? 'warning' : 'muted', "\">\n                        <div class=\"modern-info-value\">").concat(summary.errors, "</div>\n                        <div class=\"modern-info-label\">Errores</div>\n                    </div>\n                    <div class=\"modern-info-item info\" data-type=\"info\">\n                        <div class=\"modern-info-value\">").concat(summary.assertions, "</div>\n                        <div class=\"modern-info-label\">Verificaciones</div>\n                    </div>\n                    ").concat(summary.skipped > 0 || summary.incomplete > 0 || summary.risky > 0 ? "\n                        <div class=\"modern-info-item ".concat(summary.skipped > 0 ? 'warning' : 'muted', "\" data-type=\"").concat(summary.skipped > 0 ? 'warning' : 'muted', "\">\n                            <div class=\"modern-info-value\">").concat(summary.skipped, "</div>\n                            <div class=\"modern-info-label\">Omitidos</div>\n                        </div>\n                        <div class=\"modern-info-item ").concat((summary.incomplete || 0) > 0 ? 'warning' : 'muted', "\" data-type=\"").concat((summary.incomplete || 0) > 0 ? 'warning' : 'muted', "\">\n                            <div class=\"modern-info-value\">").concat(summary.incomplete || 0, "</div>\n                            <div class=\"modern-info-label\">Incompletos</div>\n                        </div>\n                        <div class=\"modern-info-item ").concat(summary.risky > 0 ? 'warning' : 'muted', "\" data-type=\"").concat(summary.risky > 0 ? 'warning' : 'muted', "\">\n                            <div class=\"modern-info-value\">").concat(summary.risky || 0, "</div>\n                            <div class=\"modern-info-label\">Riesgosos</div>\n                        </div>\n                    ") : '', "\n                </div>\n                \n                <!-- Grid 2: M\xE9tricas de rendimiento (derecha) -->\n                <div class=\"modern-info-grid modern-info-grid-performance\">\n                    ").concat(summary.time ? "<div class=\"modern-info-item info\" data-type=\"info\">\n                        <div class=\"modern-info-value\">".concat(summary.time, "</div>\n                        <div class=\"modern-info-label\">Tiempo</div>\n                    </div>") : '', "\n                    ").concat(summary.memory ? "<div class=\"modern-info-item info\" data-type=\"info\">\n                        <div class=\"modern-info-value\">".concat(summary.memory, "</div>\n                        <div class=\"modern-info-label\">Memoria</div>\n                    </div>") : '', "\n                </div>\n            </div>");
      }

      // Output completo
      if (results.output) {
        html += "<div class=\"modern-section\">\n                <pre class=\"modern-code-block modern-code-block-dark\">".concat(this.escapeHtml(results.output), "</pre>\n            </div>");
      }

      // Información de ejecución
      if (results.execution_time) {
        html += "<div class=\"mt-3 text-muted small\">\n                \u23F1\uFE0F Tiempo de ejecuci\xF3n: ".concat(results.execution_time, "ms\n                ").concat(results.exit_code !== undefined ? " | C\xF3digo de salida: ".concat(results.exit_code) : '', "\n            </div>");
      }
      html += '</div>';
      testResultsDiv.innerHTML = html;

      // Scroll al div de resultados suavemente
      testResultsDiv.scrollIntoView({
        behavior: 'smooth',
        block: 'nearest'
      });
    }
    ...
    value: function showMessage(message) {
      ...
      testResultsDiv.innerHTML = "<div class=\"modern-alert modern-alert-".concat(alertType, "\">\n            <div class=\"modern-alert-icon\">").concat(alertIcon, "</div>\n            <div class=\"modern-alert-content\">\n                <div class=\"modern-alert-title\">").concat(message, "</div>\n            </div>\n        </div>");
    }
    ...
    key: "updateSpecificButtonState",
    value: function updateSpecificButtonState(buttonId, isRunning) {
      var loadingText = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'Ejecutando...';
      ...
      if (isRunning) {
        button.innerHTML = "<span class=\"spinner-border spinner-border-sm me-2\"></span>".concat(loadingText);
      } else {
        // Restaurar contenido original
        var content = originalContent || button.innerHTML;
    ...
    value: function updateButtonStates(isRunning) {
      var specificButtonId = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      if (specificButtonId) {
        ...
        var allButtons = ['devtools-runTests', 'devtools-runQuickTest', 'devtools-clearResults', 'devtools-testConnectivity'];
        ...
        var runButton = document.getElementById('devtools-runTests');
        var quickButton = document.getElementById('devtools-runQuickTest');
        var clearButton = document.getElementById('devtools-clearResults');
        if (runButton) {
          runButton.disabled = isRunning;
          runButton.innerHTML = isRunning ? '<span class="spinner-border spinner-border-sm me-2"></span>Ejecutando...' : '<i class="dashicons dashicons-yes-alt"></i> 🚀 Run Selected Tests';
        }
        if (quickButton) {
          quickButton.disabled = isRunning;
          quickButton.innerHTML = isRunning ? '<span class="spinner-border spinner-border-sm me-2"></span>Ejecutando...' : '<i class="dashicons dashicons-performance"></i> ⚡ Quick Test';
        }
        if (clearButton) {
...
/* harmony default export */ __webpack_exports__["default"] = (TestRunner);
...
/******/ })()
;
//# sourceMappingURL=dev-tools.min.js.map