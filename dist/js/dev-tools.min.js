        ...
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.n) {
            ...
            case 3:
              _context9.p = 3;
              _t8 = _context9.v;
              container.innerHTML = "<div class=\"alert alert-danger\">Error loading system info: ".concat(_t8.message, "</div>");
            case 4:
              return _context9.a(2);
          }
        }, _callee9, this, [[1, 3]]);
...
var TestRunner = /*#__PURE__*/function () {
  ...
  return _createClass(TestRunner, [{
    ...
    value: function displayResults(results) {
      ...
      if (results.command) {
        html += "<div class=\"alert alert-info mb-3\">\n                <strong>\uD83D\uDCDD Comando ejecutado:</strong><br>\n                <code class=\"small\">".concat(this.escapeHtml(results.command), "</code>\n            </div>");
      }

      // Resumen de resultados
      if (results.summary) {
        var summary = results.summary;
        var statusClass = summary.status === 'success' ? 'success' : summary.status === 'error' ? 'danger' : 'warning';
        var statusIcon = summary.status === 'success' ? '✅' : summary.status === 'error' ? '❌' : '⚠️';
        html += "<div class=\"alert alert-".concat(statusClass, " mb-3\">\n                <h6>").concat(statusIcon, " Resumen de Tests</h6>\n                <div class=\"row\">\n                    <div class=\"col-md-6\">\n                        <p class=\"mb-1\"><strong>Total:</strong> ").concat(summary.total_tests, "</p>\n                        <p class=\"mb-1\"><strong>Pasados:</strong> <span class=\"text-success\">").concat(summary.passed, "</span></p>\n                        <p class=\"mb-1\"><strong>Fallidos:</strong> <span class=\"text-danger\">").concat(summary.failed, "</span></p>\n                    </div>\n                    <div class=\"col-md-6\">\n                        <p class=\"mb-1\"><strong>Errores:</strong> <span class=\"text-warning\">").concat(summary.errors, "</span></p>\n                        <p class=\"mb-1\"><strong>Omitidos:</strong> <span class=\"text-muted\">").concat(summary.skipped, "</span></p>\n                        <p class=\"mb-1\"><strong>Aserciones:</strong> ").concat(summary.assertions, "</p>\n                    </div>\n                </div>\n                ").concat(summary.time ? "<p class=\"mb-0\"><strong>\u23F1\uFE0F Tiempo:</strong> ".concat(summary.time, "</p>") : '', "\n                ").concat(summary.memory ? "<p class=\"mb-0\"><strong>\uD83D\uDCBE Memoria:</strong> ".concat(summary.memory, "</p>") : '', "\n            </div>");
      }

      // Output completo
      if (results.output) {
        html += "<div class=\"card\">\n                <div class=\"card-header\">\n                    <h6 class=\"mb-0\">\uD83D\uDD0D Output Completo</h6>\n                </div>\n                <div class=\"card-body p-0\">\n                    <pre class=\"bg-dark text-light p-3 m-0 rounded-bottom\" style=\"max-height: 300px; overflow-y: auto; font-size: 0.85rem;\">".concat(this.escapeHtml(results.output), "</pre>\n                </div>\n            </div>");
      }
    ...
    value: function showMessage(message) {
      ...
      testResultsDiv.innerHTML = "<div class=\"alert ".concat(alertClass, " mb-0\">").concat(message, "</div>");
    }
