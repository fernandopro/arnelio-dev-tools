...
var DevTools = /*#__PURE__*/function () {
  ...
  return _createClass(DevTools, [{
    ...
    value: function bindQuickActions() {
      ...
      // Run Tests
      var runTestsBtn = document.querySelector('[data-action="run-tests"]');
      if (runTestsBtn) {
        runTestsBtn.addEventListener('click', function () {
          return _this4.runTests();
        });
      }
  ...
  return _createClass(TestRunner, [{
    ...
    value: (function () {
      var _runTests = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        ...
        var testTypes, verbose, coverage, response, _t3;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              if (!this.isRunning) {
            ...
            case 1:
              ...
              testTypes = [];
              if ((_document$getElementB = document.getElementById('unitTests')) !== null && _document$getElementB !== void 0 && _document$getElementB.checked) testTypes.push('unit');
              if ((_document$getElementB2 = document.getElementById('integrationTests')) !== null && _document$getElementB2 !== void 0 && _document$getElementB2.checked) testTypes.push('integration');
              if ((_document$getElementB3 = document.getElementById('database')) !== null && _document$getElementB3 !== void 0 && _document$getElementB3.checked) testTypes.push('database');
              verbose = ((_document$getElementB4 = document.getElementById('verboseOutput')) === null || _document$getElementB4 === void 0 ? void 0 : _document$getElementB4.checked) || false;
              coverage = ((_document$getElementB5 = document.getElementById('generateCoverage')) === null || _document$getElementB5 === void 0 ? void 0 : _document$getElementB5.checked) || false; // Debug de valores leídos
              console.log('🔍 TestRunner Debug - Values read from checkboxes:');
              console.log('  - testTypes:', testTypes);
              console.log('  - verbose:', verbose);
              console.log('  - coverage:', coverage);
              console.log('  - verboseOutput element:', document.getElementById('verboseOutput'));
              console.log('  - generateCoverage element:', document.getElementById('generateCoverage'));
            ...
            case 2:
              this.isRunning = true;
              _context3.p = 3;
              this.showMessage("\uD83D\uDD04 Ejecutando tests: ".concat(testTypes.join(', '), "..."), 'info');
              _context3.n = 4;
              return this.makeTestAjaxRequest('run_tests', {
    ...
    value: function displayResults(results) {
      ...
      if (results.command) {
        html += "<div class=\"alert alert-info mb-3\">\n                <strong>Comando ejecutado:</strong> <code>".concat(results.command, "</code>\n            </div>");
      }
      ...
      if (results.summary) {
        ...
        html += "<div class=\"alert alert-".concat(statusClass, " mb-3\">\n                <h5>\uD83D\uDCCA Resumen de Tests</h5>\n                <div class=\"row\">\n                    <div class=\"col-md-6\">\n                        <p><strong>Total:</strong> ").concat(summary.total_tests, "</p>\n                        <p><strong>Pasados:</strong> ").concat(summary.passed, "</p>\n                        <p><strong>Fallidos:</strong> ").concat(summary.failed, "</p>\n                    </div>\n                    <div class=\"col-md-6\">\n                        <p><strong>Errores:</strong> ").concat(summary.errors, "</p>\n                        <p><strong>Omitidos:</strong> ").concat(summary.skipped, "</p>\n                        <p><strong>Aserciones:</strong> ").concat(summary.assertions, "</p>\n                    </div>\n                </div>\n                ").concat(summary.time ? "<p><strong>Tiempo:</strong> ".concat(summary.time, "</p>") : '', "\n                ").concat(summary.memory ? "<p><strong>Memoria:</strong> ".concat(summary.memory, "</p>") : '', "\n            </div>");
      }

      // Output completo
      if (results.output) {
        html += "<div class=\"card\">\n                <div class=\"card-header\">\n                    <h6>\uD83D\uDD0D Output Completo</h6>\n                </div>\n                <div class=\"card-body\">\n                    <pre class=\"bg-dark text-light p-3 rounded\" style=\"max-height: 400px; overflow-y: auto;\">".concat(this.escapeHtml(results.output), "</pre>\n                </div>\n            </div>");
      }

      // Información de ejecución
      if (results.execution_time) {
        html += "<div class=\"mt-3 text-muted small\">\n                \u23F1\uFE0F Tiempo de ejecuci\xF3n: ".concat(results.execution_time, "s\n                ").concat(results.exit_code !== undefined ? " | C\xF3digo de salida: ".concat(results.exit_code) : '', "\n            </div>");
      }
      html += '</div>';
    ...
    value: function showMessage(message) {
      ...
      testResultsDiv.innerHTML = "<div class=\"alert ".concat(alertClass, "\">").concat(message, "</div>");
    }
